            ...
            using (var writer = new StreamWriter(fileName, true, Encoding.ASCII))
            {
                
                {
...

                    {
                        ...
                        case 0xee: writer.WriteLine(pc.ToString("X") + ":" + " INC    ${0:X2}{1:X2}", code[2], code[1]); opBytes = 3; break; //https://www.youtube.com/watch?v=RINq7amRdzM
                        ...
                        case 0xfe: writer.WriteLine(pc.ToString("X") + ":" + " INC    ${0:X2}{1:X2}, X", code[2], code[1]); opBytes = 3; break;
                            ...
                            //https://www.youtube.com/watch?v=VfY0Zpe6Hl0
